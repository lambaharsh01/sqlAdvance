...
DISCUSSION ON FIRST_VALUE & LAST_VALUE

IF I DO LAST_VALUE(col) IT MIGHT BE SIMILAR TO LAG(col, 1) BECAUSE LAST_VALUE() DOES NOT IMPLEMENT 
    ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING 
    OR
    ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW

FIRST_VALUE() ON THE OTHER HAND HAS IMPLICIT IMPLEMENTATION OF ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW

TO GET THE ABSOLUTE LAST_VALUE() OR ABSOLUTE FIRST_VALUE() IN THE SELECTED DATASET USE ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING